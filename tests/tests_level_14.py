...
print(str(int(nummer) * int(nummertwee)))""", result)
  ...
  def test_transpile_ask(self):
    result = hedy.transpile("antwoord = input('wat is je lievelingskleur?')", 14)
...
if antwoord == 20:
    ...
    print('Foutje')
    print('Het antwoord moest zijn ' antwoord)""", 14)
...
print('computer koos ' computerkeuze)""", 14)
...
for i in range(1, 10):
  print(i)
print('wie niet weg is is gezien')""", 14)
...
if getal != 5:
    ...
    print('Fout! Je mocht geen 5 zeggen')""", 14)
