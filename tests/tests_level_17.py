...
print(str(int(nummer) * int(nummertwee)))""", result)
  ...
  def test_transpile_ask(self):
    result = hedy.transpile("antwoord = input('wat is je lievelingskleur?')", 17)
...
if antwoord == 20:
    ...
    print('Foutje')
    print('Het antwoord moest zijn ' antwoord)""", 17)
...
print('computer koos ' computerkeuze)""", 17)
...
for i in range(1, 10):
  print(i)
print('wie niet weg is is gezien')""", 17)
...
if getal != 5:
    ...
    print('Fout! Je mocht geen 5 zeggen')""", 17)
...
if str(getal) != str('5'):
  ...
  def test_smaller(self):
    result = hedy.transpile("""leeftijd = input('Hoe oud ben jij?')
if leeftijd < 12:
    print('Dan ben je jonger dan ik!')""", 17)
    self.assertEqual(result, """leeftijd = input('Hoe oud ben jij?')
if str(leeftijd) < str('12'):
  ...
  def test_bigger(self):
    result = hedy.transpile("""leeftijd = input('Hoe oud ben jij?')
if leeftijd > 12:
    print('Dan ben je ouder dan ik!')""", 17)
    self.assertEqual(result, """leeftijd = input('Hoe oud ben jij?')
if str(leeftijd) > str('12'):
...
if str(leeftijd) >= str('11'):
  ...
  def test_bool_true(self):
    result = hedy.transpile("""ja = True
if ja == True:
    print('ja')""",17)
    self.assertEqual(result, """ja = True
if ja == True:
  print('ja')""")

  def test_bool_false(self):
    result = hedy.transpile("""ja = False
if ja == False:
    print('ja')""",17)
    self.assertEqual(result, """ja = False
if ja == False:
  print('ja')""")
...
if ja == False:
  ...
  def test_bool(self):
    result = hedy.transpile("""goedantwoord = False
...
if antwoord != 25:
    ...
    goedantwoord = True
    print('Dat is goed!')
if goedantwoord == True:
    i = 10""", 17)
    self.assertEqual(result, """goedantwoord = False
antwoord = input('Wat is 5*5')
